        ...
        <div className="bg-white absolute bottom-0 w-full h-[70%] rounded-t-[40px] p-4 sm:p-6 pt-6 sm:pt-8">
          <div className="w-full mb-6 sm:mb-10">
            <img
              ...
              className="h-[300px] sm:h-[300px] object-contain mx-auto"
            />
          </div>

          <p className="text-[20px] sm:text-[23px] text-black mb-6 sm:mb-8 text-center leading-relaxed">
            Step 4: Build Higher 🌆
          </p>

          <div className="w-full flex justify-center">
            <button
              onClick={() => router.push("/season4/biydaalt/Engineer/page6")}
