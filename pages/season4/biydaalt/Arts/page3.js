  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-2 sm:p-4">
      <div className="w-full max-w-[390px] h-[100vh] sm:h-[844px] bg-[#DF6E5B] relative rounded-3xl overflow-hidden shadow-lg">
        ...
        <button 
          onClick={() => router.push("/season4/biydaalt/Arts/page2")} 
        ...
        <div className="bg-white absolute bottom-0 w-full h-[70%] rounded-t-[40px] p-4 sm:p-6 pt-6 sm:pt-8">
          ...
          <p className="text-[18px] sm:text-[18px] font-medium text-black mb-6 sm:mb-8 text-center leading-relaxed">
            🧪 Step 2: Let’s Mix!
...
🔵 Blue + 🟡 Yellow = 🟢 Green
          ...
          <div className="w-full flex justify-center">
            <button
              onClick={() => router.push("/season4/biydaalt/Arts/page4")}
